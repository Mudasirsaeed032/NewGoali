...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden font-body">
      {/* Navigation */}
      <motion.nav 
        className="border-b border-gray-100 bg-white/90 backdrop-blur-sm fixed w-full z-50"
        initial={{ y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/for-teams" className="text-gray-600 hover:text-gray-900 transition-colors font-body">For Teams</a>
              <a href="/resources" className="text-gray-600 hover:text-gray-900 transition-colors font-body">Resources</a>
            </div>
      ...
      <motion.section 
        ref={heroRef}
        style={{ y, opacity }}
        className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-blue-50/30 pt-16"
      >
            ...
            <div className="space-y-8">
              ...
              >
                <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed max-w-2xl font-body">
                  Track dues, ticket sales, donations, merch, and more in one place. 
                  Built for modern teams who want to focus on what matters most.
                </p>
              </motion.div>
      ...
      <section ref={howItWorksRef} id="how-it-works" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 relative overflow-hidden">
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Shield, title: 'Secure Payments', description: 'Bank-level security with encrypted transactions and PCI compliance for safe donations.', color: 'blue' },
              { icon: TrendingUp, title: 'Real-time Analytics', description: 'Track donations, monitor progress, and gain insights with comprehensive analytics.', color: 'purple' },
              { icon: Users, title: 'Community Building', description: 'Engage supporters with updates, photos, and milestone celebrations.', color: 'green' },
              { icon: Heart, title: 'Donor Management', description: 'Keep track of supporters and send thank you messages automatically.', color: 'pink' },
              { icon: Target, title: 'Goal Setting', description: 'Set multiple fundraising goals and track progress with visual indicators.', color: 'yellow' },
              { icon: Trophy, title: 'Team Campaigns', description: 'Create team-based fundraising with individual and collective goals.', color: 'cyan' }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
                initial={{ opacity: 0, y: 30 }}
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-title mb-4 text-gray-900">Success Stories</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto font-body">
              See how clubs are achieving their fundraising goals
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                quote: "Goali helped us raise $15,000 for new equipment in just 3 months. The platform is so easy to use!",
                name: "Jessica Martinez",
                role: "Thunder Soccer Club",
                initials: "JM",
                color: "blue"
              },
              {
                quote: "The analytics dashboard gives us incredible insights into our fundraising performance. Game changer!",
                name: "Mike Rodriguez",
                role: "Eagles Basketball",
                initials: "MR",
                color: "purple"
              },
              {
                quote: "Our community rallied behind our campaign and we exceeded our goal by 150%. Amazing platform!",
                name: "Sarah Chen",
                role: "Riverside Tennis Club",
                initials: "SC",
                color: "green"
              }
              ...
              >
                ...
                <p className="text-gray-600 mb-4 italic font-body">
                  "{testimonial.quote}"
                </p>
                <div className="flex items-center">
                  <div className={`w-10 h-10 bg-${testimonial.color}-500 rounded-full flex items-center justify-center mr-3`}>
                    <span className="text-white font-header">{testimonial.initials}</span>
                  </div>
                  <div>
                    <div className="font-header text-gray-900">{testimonial.name}</div>
                    <div className="text-gray-500 text-sm font-body">{testimonial.role}</div>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.button 
              className="border-2 border-gray-200 hover:border-gray-300 text-gray-900 px-8 py-4 rounded-xl font-header text-lg transition-all duration-200 hover:bg-gray-50"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Schedule a Demo
      ...
      <footer className="border-t border-gray-200 py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <h4 className="font-header mb-4 text-gray-900">Product</h4>
              <ul className="space-y-2 text-gray-600">
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Features</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Pricing</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Demo</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-header mb-4 text-gray-900">Support</h4>
              <ul className="space-y-2 text-gray-600">
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Help Center</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Contact</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Resources</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-header mb-4 text-gray-900">Company</h4>
              <ul className="space-y-2 text-gray-600">
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">About</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Blog</a></li>
                <li><a href="#" className="hover:text-gray-900 transition-colors font-body">Careers</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-200 mt-8 pt-8 text-center text-gray-500">
            <p className="font-body">&copy; 2024 Goali. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
